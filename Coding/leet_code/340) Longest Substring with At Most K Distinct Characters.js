s = "aaaaaaabbbaaaacdcdcdcdcdcdcdcdcdcdcdcdcdcc"
distinctCharacters = 3
// "aaaaaaabbbaaaacc"
// "eceba"

if (s.length < distinctCharacters+1) { // if the string size is less than desired Distinct Characters 
...
for (let endPoint = 0; endPoint < s.length; endPoint++) { // starting the end pointer
    ...
    while (cnt.size > distinctCharacters) { // while the size of Map is more than desired Distinct Characters 
         ...
         *  if size of map becomes more than desired Distinct Characters . (if it holds more than desired Distinct Characters at a time ) 
